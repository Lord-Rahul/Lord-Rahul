...
- 🔁 Transitioned from **MERN stack development** to the world of **InfoSec**
- 💭 Love breaking things (legally 😉) to understand how they work
- 🎯 Focused on **penetration testing, threat analysis, malware, and OSINT**

---

### 🧠 Skills Overview

#### 💻 Past Skills – Web Development (MERN)
<p>
...
#### 🛡️ Current Skills – Cybersecurity
<p>
...
- ✅ Master system/network security
- 📚 Finish Security+ and CEH
- 🧪 Build real-world security scripts
- 🎯 Win CTFs and report a bug bounty
...
| 🛠 Project | Description |
|-----------|-------------|
| 🖥️ [**C_project_2nd-sem**](https://github.com/lord-rahul/C_project_2nd-sem) | Early C programming project from college |
| 🌐 [**web-dev_projects**](https://github.com/lord-rahul/web-dev_projects) | Responsive and interactive websites built using HTML/CSS/JS |
| ⚙️ [**JS_Projects**](https://github.com/lord-rahul/JS_Projects) | Collection of JavaScript-based logic games & utilities |
| 🐍 [**Python**](https://github.com/lord-rahul/Python) | Python practice scripts for automation and logic building |
| 🤖 [**machine-learning**](https://github.com/lord-rahul/machine-learning) | Basic intro to ML concepts during my tech exploration phase |
...
<h4 align="center">"The quieter you become, the more you can hear." – Ram Dass</h4>
